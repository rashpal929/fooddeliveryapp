...
const Search = () => {
    ...
    const changePrice = (e) => {
        ...
        let storedata = toggle ? tempCopyData.sort((a, b) => a.priceNumeric - b.priceNumeric) : tempCopyData.sort((a, b) => b.priceNumeric - a.priceNumeric);
        console.log("changePrice", storedata);
        setCopyData(storedata);
    }
    ...
    return(
        <>
            ...
            <Form className="d-flex justify-content-center align-items-center mt-3 mb-5">
            ...
            <div className='container d-flex searchFilters'>
                <button className='rating'
                onClick={() => {setToggle(!toggle); changeRating(toggle)}}>Rating</button>
                <button className='rating'
                onClick={() => {setToggle(!toggle); changePrice(toggle)}}>Price</button>
